$(function() {
	//从URL里获取productld参数的值
	var productId = getQueryString('productId');
	//通过productld获取商品信息的URL
	var infoUrl = '/shg/useradmin/getproductbyid?productId=' + productId;
	//获取当前店铺设定的商品类别列表的URL
	var categoryUrl = '/shg/useradmin/getproductcategorylist';
	//更新商品信息的URL
	var productPostUrl = '/shg/useradmin/modifyproduct';
	...
	if (productId) {
		...
		getCategory();
		productPostUrl = '/shg/useradmin/addproduct';
	}
